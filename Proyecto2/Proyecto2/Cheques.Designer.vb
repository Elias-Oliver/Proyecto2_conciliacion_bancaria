...
Partial Class Cheques
    ...
    Private Sub InitializeComponent()
        ...
        ' txtNumeroCheque
        ' 
        txtNumeroCheque.Location = New Point(176, 102)
        txtNumeroCheque.Name = "txtNumeroCheque"
        txtNumeroCheque.Size = New Size(200, 23)
        ...
        dtpFechaCheque.Size = New Size(200, 23)
        ...
        ' btnRegistrar
        ' 
        btnRegistrar.BackColor = Color.FromArgb(CByte(60), CByte(120), CByte(200))
        ...
        lblTitulo.Location = New Point(16, 52)
